...
hVar.MAP_INFO["world/yxys_yoda_01"] =
{
	mapType = 4,
	uniqueID = 61,
	icon = "icon/xlobj/yoda01.png",
	icon_title = "icon/xlobj/yoda01_title.png", --标题图片
...
hVar.MAP_INFO["world/yxys_yoda_02"] =
{
	mapType = 4,
	uniqueID = 62,
	icon = "icon/xlobj/yoda02.png",
	icon_title = "icon/xlobj/yoda02_title.png", --标题图片
	dlcMapPackageName = "world/dlc_yxys_yoda", --所属的地图包名字
	level = 10062,
	chapter = 8,
...
hVar.MAP_INFO["world/yxys_yoda_03"] =
{
	mapType = 4,
	uniqueID = 63,
	icon = "icon/xlobj/yoda03.png",
	icon_title = "icon/xlobj/yoda03_title.png", --标题图片
	dlcMapPackageName = "world/dlc_yxys_yoda", --所属的地图包名字
	level = 10063,
	chapter = 8,
...
hVar.MAP_INFO["world/yxys_yoda_04"] =
{
	mapType = 4,
	uniqueID = 64,
	icon = "icon/xlobj/yoda04.png",
	icon_title = "icon/xlobj/yoda04_title.png", --标题图片
	dlcMapPackageName = "world/dlc_yxys_yoda", --所属的地图包名字
	level = 10064,
	chapter = 8,
	--nextmap = {"world/yxys_yoda_02"},
	unLock = {"world/yxys_yoda_04"}, --解锁条件
	thumbnail = "misc/selectmap_2.png",
	heroLimit = {6000,},			--第一次进行关卡时选择的英雄
	sound = {"music/stage_01", "music/stage_02", "music/stage_03", "music/stage_04", "music/stage_05", "music/stage_06", "music/stage_07", "music/stage_08", "music/stage_09", "music/stage_10", "music/stage_11",}, --背景音乐
